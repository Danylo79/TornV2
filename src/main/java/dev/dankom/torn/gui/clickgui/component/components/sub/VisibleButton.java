...
public class VisibleButton extends Component { // Remove this class if you don't want it (it's kinda useless)
	...
	public void renderComponent() {
		...
		Minecraft.getMinecraft().fontRendererObj.drawStringWithShadow("Visible: " + mod.isHidden(), (parent.parent.getX() + 7) * 2, (parent.parent.getY() + offset + 2) * 2 + 5, -1);
